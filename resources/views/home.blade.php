...
@section('content')
    ...
    <section id="interiors" class="category-block-section card-box">
        <div class="cat-left-banner home-outdoor-banner" style="background-image: linear-gradient(rgba(0,0,0,0.1), rgba(0,0,0,0.15)), url('https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=500&auto=format&fit=crop&q=80');">
            <div class="cat-banner-content">
                <h2 class="cat-banner-title">Home and<br>outdoor</h2>
                <button class="btn btn-white btn-sm category-source-btn" data-category="Home and Outdoor">Source now</button>
            </div>
        </div>
        ...
        <div class="cat-products-grid">
            @php
                $homeProducts = [
                    ['id' => 'ho-1', 'name' => 'Premium Soft Chair', 'price' => 19, 'img' => 'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=200&auto=format&fit=crop&q=80', 'title' => 'Soft chairs'],
                    ['id' => 'ho-2', 'name' => 'Classic Sofa Set', 'price' => 39, 'img' => 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=200&auto=format&fit=crop&q=80', 'title' => 'Sofa & chair'],
                    ['id' => 'ho-3', 'name' => 'Kitchen Ceramic Dishes', 'price' => 10, 'img' => 'https://images.unsplash.com/photo-1610701596007-11502861dcfa?w=200&auto=format&fit=crop&q=80', 'title' => 'Kitchen dishes'],
                    ['id' => 'ho-4', 'name' => 'Smart Watch Tracker', 'price' => 19, 'img' => 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=200&auto=format&fit=crop&q=80', 'title' => 'Smart watches'],
                    ['id' => 'ho-5', 'name' => 'High-speed Kitchen Mixer', 'price' => 85, 'img' => 'https://images.unsplash.com/photo-1578643463396-0997cb5328c1?w=200&auto=format&fit=crop&q=80', 'title' => 'Kitchen mixer'],
                    ['id' => 'ho-6', 'name' => 'Professional Food Blender', 'price' => 39, 'img' => 'https://images.unsplash.com/photo-1570222094114-d054a817e56b?w=200&auto=format&fit=crop&q=80', 'title' => 'Blenders'],
                    ['id' => 'ho-7', 'name' => 'Modern Home Toaster', 'price' => 19, 'img' => 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=200&auto=format&fit=crop&q=80', 'title' => 'Home appliance'],
                    ['id' => 'ho-8', 'name' => 'Espresso Coffee Maker', 'price' => 15, 'img' => 'https://images.unsplash.com/photo-1517256064527-09c53b2d0bc6?w=200&auto=format&fit=crop&q=80', 'title' => 'Coffee maker']
                ];
            @endphp
            @foreach($homeProducts as $product)
            <div class="product-item-card product-action-card d-flex justify-content-between" data-id="{{ $product['id'] }}" data-name="{{ $product['name'] }}" data-price="{{ $product['price'] }}">
                <div class="item-text">
                    <h3 class="product-title">{{ $product['title'] }}</h3>
                    <p class="product-price mb-0">From USD {{ $product['price'] }}</p>
                </div>
                <div class="item-img">
    ...
    <section id="tech" class="category-block-section card-box">
        <div class="cat-left-banner electronics-banner" style="background-image: linear-gradient(rgba(0,0,0,0.1), rgba(0,0,0,0.15)), url('https://images.unsplash.com/photo-1542751371-adc38448a05e?w=500&auto=format&fit=crop&q=80');">
            <div class="cat-banner-content">
                <h2 class="cat-banner-title">Consumer<br>electronics and<br>gadgets</h2>
                <button class="btn btn-white btn-sm category-source-btn" data-category="Consumer Electronics">Source now</button>
            </div>
        </div>
        ...
        <div class="cat-products-grid">
            @php
                $elecProducts = [
                    ['id' => 'el-1', 'name' => 'Fitness Smartwatch V2', 'price' => 19, 'img' => 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=200&auto=format&fit=crop&q=80', 'title' => 'Smart watches'],
                    ['id' => 'el-2', 'name' => 'Compact Action Camera', 'price' => 19, 'img' => 'https://images.unsplash.com/photo-1502920917128-1da500764c6e?w=200&auto=format&fit=crop&q=80', 'title' => 'Cameras'],
                    ['id' => 'el-3', 'name' => 'Studio Sound Headphones', 'price' => 19, 'img' => 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=200&auto=format&fit=crop&q=80', 'title' => 'Headphones'],
                    ['id' => 'el-4', 'name' => 'Elegant Smart Watch Gold', 'price' => 22, 'img' => 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=200&auto=format&fit=crop&q=80', 'title' => 'Smart watches'],
                    ['id' => 'el-5', 'name' => 'Pro Console Gaming Set', 'price' => 34, 'img' => 'https://images.unsplash.com/photo-1612287230202-1bf1d85d1bdf?w=200&auto=format&fit=crop&q=80', 'title' => 'Gaming set'],
                    ['id' => 'el-6', 'name' => 'Ultra Book Laptop PC', 'price' => 340, 'img' => 'https://images.unsplash.com/photo-1496181130204-7552cc14f1d0?w=200&auto=format&fit=crop&q=80', 'title' => 'Laptops & PC'],
                    ['id' => 'el-7', 'name' => 'Slim Smartphone Android', 'price' => 19, 'img' => 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=200&auto=format&fit=crop&q=80', 'title' => 'Smartphones'],
                    ['id' => 'el-8', 'name' => 'Glass Electric Kettle', 'price' => 10, 'img' => 'https://images.unsplash.com/photo-1594228135964-943f25d905aa?w=200&auto=format&fit=crop&q=80', 'title' => 'Electric kettle']
                ];
            @endphp
